        ...
        <ul className="flex gap-4 w-full grid-cols-4 justify-around">
          <li>
            ...
            >
              ...
              <span style={{ color: aviaStyles.svgColor }}>{t("avia")}</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span style={{ color: trainsStyles.svgColor }}>
                {t("trains")}
              </span>
            </Link>
          </li>
          <li>
            ...
            >
              ...
              <span style={{ color: toursStyles.svgColor }}>{t("tours")}</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span style={{ color: menuStyles.svgColor }}>{t("menu")}</span>
            </Link>
          </li>
        </ul>
      </div>
