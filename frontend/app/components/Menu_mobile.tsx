...
import { useTheme } from "../context/ThemeContext"; // Импортируем контекст для использования темы
...
export default function Menu_mobile() {
  ...
  const svgColor = theme === "light" ? "#0271BD" : "#D6D6D6";
  useEffect(() => {
    // Убедимся, что компонент монтируется только на клиенте
    setIsMounted(true);
  }, []);

  // Если компонент еще не смонтирован, ничего не рендерим, чтобы избежать проблемы с гидратацией
  ...
  const getButtonStyles = (buttonPath: string) => {
    ...
    if (isActive) {
      return {
        bgColor: theme === "light" ? "#0271BD" : "#003E66",
        svgColor: "#3BAEFF",
      };
    } else {
      return {
  ...
  const menuStyles = getButtonStyles("/menu");

  return (
    <div className="w-full h-[70px] flex bottom-0 fixed lg:hidden justify-center bg-[var(--color-menu-mobile--background)]">
      <ul className="flex gap-4 w-full grid-cols-4 justify-around">
        <li>
          <Link
            href="/"
          ...
          >
            ...
            <span style={{ color: aviaStyles.svgColor }}>Авиа</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            <div className="w-[60px] h-[30px] flex justify-center items-center">
              <svg width="40" height="12">
                ...
                <path
                  fill={trainsStyles.svgColor}
                  d="M18.8537 10.7465L19.072 11.5565L14.5424 11.6569L14.4481 10.9678L18.8537 10.7465ZM4.14483 11.9487L4.30238 12.3161C4.72598 12.4157 14.9706 12.1777 15.7325 12.1683C15.7325 12.1683 23.3881 12.1468 27.1384 11.9901C27.1381 11.6819 25.7381 9.15086 25.3451 9.17801L0.910564 11.8492C0.910564 11.8492 0.296676 11.888 0 11.9618L0.00458978 12.119L4.14483 11.9487Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M25.6328 4.58375C25.7671 4.6816 28.2217 5.62029 28.5696 5.74839L31.5252 6.91762L31.2761 6.40622C30.6669 5.33297 30.0754 4.64215 29.1815 3.81528C28.4685 3.15584 26.6127 1.8731 25.6328 2.08855V4.58375Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M20.1457 4.54005C20.1457 4.54005 22.7665 3.86246 23.4285 3.84351C22.8734 4.07934 20.9078 4.54477 20.1406 4.77003L20.1464 5.70835L24.7514 4.65417V2.20264C24.3904 2.27812 23.8939 2.43852 23.5559 2.54929C23.0273 2.72249 20.1457 3.56601 20.1457 3.56601V4.54005Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M12.2425 6.49804C12.4381 6.49686 15.3651 5.70776 15.9091 5.60004L18.655 4.9127C18.8776 4.85201 19.3806 4.77876 19.5936 4.67054L19.5975 3.72607L13.1128 5.63135C12.8682 5.69819 12.4927 5.80343 12.2383 5.9042L12.2425 6.49804Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M12.2375 7.51397C12.5123 7.53366 14.4574 7.01672 14.9973 6.90012L19.5931 5.86153L19.6021 4.93408C19.1251 5.01789 12.3812 6.91266 12.2363 6.98398L12.2375 7.51397Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M8.77539 8.30975C9.20074 8.24203 11.2561 7.77654 11.7843 7.61402V7.08398L8.77539 7.90209V8.30975Z"
                />
                <path
                  fill={trainsStyles.svgColor}
                  d="M11.7833 6.63393V6.03369L9.84766 6.64388V7.12434L11.7833 6.63393Z"
                />
              </svg>
            </div>
            <span style={{ color: trainsStyles.svgColor }}>Ж/д</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <span style={{ color: toursStyles.svgColor }}>Туры</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <span style={{ color: menuStyles.svgColor }}>Меню</span>
          </Link>
        </li>
      </ul>
    </div>
